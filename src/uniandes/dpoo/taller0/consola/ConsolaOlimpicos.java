...
public class ConsolaOlimpicos
{
	...
	public void ejecutarAplicacion()
	{
		...
		while (continuar)
		{
			try
			{
				...
				else if (opcion_seleccionada ==1  && calculadora != null)
	...
	public void mostrarMenu()
	{
		...
		System.out.println("0. Cargar un archivo de atletas");
		System.out.println("1. Consultar nombre de un atleta");
	...
	private void ejecutarAtletaPorNombre()
	{
		...
		String nombreAtleta = input("Ingresar nombre del atleta:");
		List<Map<String, Object>> atletas = calculadora.atletasPorNombre(nombreAtleta);
